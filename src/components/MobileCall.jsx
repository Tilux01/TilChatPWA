...
const MobileCall = ({ setCallBlock, currentCallCred, currentCount, currentCallWallpaper, micActive, setMicActive, callActive, setCallActive, setCurrentCount, setChatInfo, setCallChatInfo, callChatInfo, setChatState, setChatFriendDetail, setCurrentCallWallpaper, setDisplayCallBlock, setCallType, callEndTimer, callTimerDown, callAccepted, setCurrentIncomingCall, setCallEnded, handleEndCall, cleanupCall, callType, remoteAudio, localAudio, setVideoView, videoView, remoteVideoTrack, localVideoTrack }) => {
    ...
    return (
        <div className='call-overall mobile-overall'>
