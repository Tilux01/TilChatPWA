...
const UserStatus = (props) => {
    ...
    const uploadStat = async() =>{
        ...
        const reducedQualityBase64 = await reduceMediaQualityToFile(file, 0.5, 1024);
        console.log(reducedQualityBase64.file);
        const reader = new FileReader
        reader.addEventListener("load",(e)=>{
            setBase64(e.target.result)
            raw.value = ""
        })
        reader.readAsDataURL(reducedQualityBase64.file)
