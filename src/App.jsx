    ...
    setupWebPush();
      ...
      return(
        <ViewStateContext.Provider value={props.ViewState}>
          ...
          {!chat?<View chatState={chatState} setChatState={setChatState} userCredentials={userCredentials} setViewState={props.setViewState} ViewState={props.ViewState} iframeLink={props.iframeLink} setIframeLink={props.setIframeLink} setChatInfo={setChatInfo} feedObject={feedObject} setFeedObject={setFeedObject} setChat={setChat}/>:<ChatDisplay deviceUserAgent={deviceUserAgent} otherDevices={otherDevices} mutualRender={mutualRender} setMutualRender={setMutualRender} setChatState={setChatState} chatState={chatState} setChatInfo={setChatInfo} chatInfo={chatInfo} chatFriendDetail={chatFriendDetail}/>}
          {/* <FeedPreview/> */}
